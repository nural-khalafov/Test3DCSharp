...
public partial class UpperbodyStateMachine : Node
{
    [Export]
    ...
    public override async void _Ready()
    {
        foreach (Node child in GetChildren())
        {
            ...
            {
                GD.PushWarning("Combat State machine contains incompatible child node");
            }
        }
    ...
    private void OnChildTransition(StringName newStateName)
    {
        ...
        {
            GD.PushWarning($"Combat State '{newStateName}' does not exist or is already active.");
        }
    }
}
